...
describe('Ebenenmischer', () => {
  ...
  const uebersetzt = () => { cy.get('#state', { timeout: 30000 }).invoke('text').should('not.match', /übersetzt|Compiling/); cy.wait(600); };   // die Fassung mit Masken wird beim ersten Gebrauch nebenher übersetzt
